...
The dictionaries used in this study date back to the 17th century which is a useful information that we will take into consideration. As far as I am aware, the noun *permit* is more recent than the verb, from which it derived. This could mean that when the noun was introduced in dictionaries, the verb already had a __"stable" stress pattern__ (namely, a 2nd syllable stress). In the beginning, the noun might have shared this pattern, and then went through a process of change in terms of stress, so that its use could be __contrasted with the use of the verb__. Therefore the noun would have started out with a 2nd syllable stress, and then gradually acquired a 1st syllable stress instead, which might explain we find some traces of this 2nd syllable stress in our permit(noun) data. 
